...
//AGGIUNTO DA BAFIO
		...
		} else if(qa_get_logged_in_userid() && $requestparts[0] == '' && count($favoritecategory)) {

			qa_set_template(strlen($firstlower) ? $firstlower : 'qa'); // will be changed later
			$qa_content = require QA_INCLUDE_DIR.'pages/login-default.php'; // handles many other pages, including custom pages and page modules
