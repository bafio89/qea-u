...
//INSERITO DA BAFIO
	...
	list($questions1, $questions2, $categories, $categoryid, $custompage)=qa_db_select_with_pending(
		qa_db_qs_selectspec($userid, $selectsort, 0, $slugs, null, false, false, qa_opt_if_loaded('page_size_activity')),
...
//AGGIUNTO DA BAFIO RIVEDI
		$sometitle = str_replace('recenti', '', $sometitle);
...
//	Prepare and return content for theme for Q&A listing page
	...
	if($countslugs > 0 )	
		$qa_content['navigation']['sub']=qa_qs_sub_navigation_cat($sort,array(), $slugs);
