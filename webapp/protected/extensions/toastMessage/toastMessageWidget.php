...
class toastMessageWidget extends CWidget{
	...
	*/
	...
	public function init(){
		...
		Yii::app()->getClientScript()->registerScriptFile($this->assets.'/jquery.toastmessage.js',CClientScript::POS_HEAD);
		Yii::app()->getClientScript()->registerScriptFile($this->assets.'/com.qiris.error.js',CClientScript::POS_HEAD);
	}
