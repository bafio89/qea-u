...
class BSHtml extends CHtml
{
    ...
    // ICON
    // --------------------------------------------------
    const FONTAWESOME_ADJUST = 'fa-adjust';
    const FONTAWESOME_ALIGN_CENTER = 'fa-align-center';
    const FONTAWESOME_ALIGN_JUSTIFY = 'fa-align-justify';
    const FONTAWESOME_ALIGN_LEFT = 'fa-align-left';
    const FONTAWESOME_ALIGN_RIGHT = 'fa-align-right';
    const FONTAWESOME_ARROW_DOWN = 'fa-arrow-down';
    const FONTAWESOME_ARROW_LEFT = 'fa-arrow-left';
    const FONTAWESOME_ARROW_RIGHT = 'fa-arrow-right';
    const FONTAWESOME_ARROW_UP = 'fa-arrow-up';
    const FONTAWESOME_ASTERISK = 'fa-asterisk';
    const FONTAWESOME_BACKWARD = 'fa-backward';
    const FONTAWESOME_BAN_CIRCLE = 'fa-ban-circle';
    const FONTAWESOME_BARCODE = 'fa-barcode';
    const FONTAWESOME_BELL = 'fa-bell';
    const FONTAWESOME_BOLD = 'fa-bold';
    const FONTAWESOME_BOOK = 'fa-book';
    const FONTAWESOME_BOOKMARK = 'fa-bookmark';
    const FONTAWESOME_BRIEFCASE = 'fa-briefcase';
    const FONTAWESOME_BULLHORN = 'fa-bullhorn';
    const FONTAWESOME_CALENDAR = 'fa-calendar';
    const FONTAWESOME_CAMERA = 'fa-camera';
    const FONTAWESOME_CERTIFICATE = 'fa-certificate';
    const FONTAWESOME_CHECK = 'fa-check';
    const FONTAWESOME_CHEVRON_DOWN = 'fa-chevron-down';
    const FONTAWESOME_CHEVRON_LEFT = 'fa-chevron-left';
    const FONTAWESOME_CHEVRON_RIGHT = 'fa-chevron-right';
    const FONTAWESOME_CHEVRON_UP = 'fa-chevron-up';
    const FONTAWESOME_CIRCLE_ARROW_DOWN = 'fa-circle-arrow-down';
    const FONTAWESOME_CIRCLE_ARROW_LEFT = 'fa-circle-arrow-left';
    const FONTAWESOME_CIRCLE_ARROW_RIGHT = 'fa-circle-arrow-right';
    const FONTAWESOME_CIRCLE_ARROW_UP = 'fa-circle-arrow-up';
    const FONTAWESOME_CLOUD = 'fa-cloud';
    const FONTAWESOME_CLOUD_DOWNLOAD = 'fa-cloud-download';
    const FONTAWESOME_CLOUD_UPLOAD = 'fa-cloud-upload';
    const FONTAWESOME_COG = 'fa-cog';
    const FONTAWESOME_COLLAPSE_DOWN = 'fa-collapse-down';
    const FONTAWESOME_COLLAPSE_UP = 'fa-collapse-up';
    const FONTAWESOME_COMMENT = 'fa-comment';
    const FONTAWESOME_COMPRESSED = 'fa-compressed';
    const FONTAWESOME_COPYRIGHT_MARK = 'fa-copyright-mark';
    const FONTAWESOME_CREDIT_CARD = 'fa-credit-card';
    const FONTAWESOME_CUTLERY = 'fa-cutlery';
    const FONTAWESOME_DASHBOARD = 'fa-dashboard';
    const FONTAWESOME_DOWNLOAD = 'fa-download';
    const FONTAWESOME_DOWNLOAD_ALT = 'fa-download-alt';
    const FONTAWESOME_EARPHONE = 'fa-earphone';
    const FONTAWESOME_EDIT = 'fa-edit';
    const FONTAWESOME_EJECT = 'fa-eject';
    const FONTAWESOME_ENVELOPE = 'fa-envelope';
    const FONTAWESOME_EURO = 'fa-euro';
    const FONTAWESOME_EXCLAMATION_SIGN = 'fa-exclamation-sign';
    const FONTAWESOME_EXPAND = 'fa-expand';
    const FONTAWESOME_EXPORT = 'fa-export';
    const FONTAWESOME_EYE_CLOSE = 'fa-eye-slash';
    const FONTAWESOME_EYE_OPEN = 'fa-eye';
    const FONTAWESOME_FACETIME_VIDEO = 'fa-facetime-video';
    const FONTAWESOME_FAST_BACKWARD = 'fa-fast-backward';
    const FONTAWESOME_FAST_FORWARD = 'fa-fast-forward';
    const FONTAWESOME_FILE = 'fa-file';
    const FONTAWESOME_FILM = 'fa-film';
    const FONTAWESOME_FILTER = 'fa-filter';
    const FONTAWESOME_FIRE = 'fa-fire';
    const FONTAWESOME_FLAG = 'fa-flag';
    const FONTAWESOME_FLASH = 'fa-flash';
    const FONTAWESOME_FLOPPY_DISK = 'fa-floppy-disk';
    const FONTAWESOME_FLOPPY_OPEN = 'fa-floppy-open';
    const FONTAWESOME_FLOPPY_REMOVE = 'fa-floppy-remove';
    const FONTAWESOME_FLOPPY_SAVE = 'fa-floppy-save';
    const FONTAWESOME_FLOPPY_SAVED = 'fa-floppy-saved';
    const FONTAWESOME_FOLDER_CLOSE = 'fa-folder-close';
    const FONTAWESOME_FOLDER_OPEN = 'fa-folder-open';
    const FONTAWESOME_FONT = 'fa-font';
    const FONTAWESOME_FORWARD = 'fa-forward';
    const FONTAWESOME_FULLSCREEN = 'fa-fullscreen';
    const FONTAWESOME_GBP = 'fa-gbp';
    const FONTAWESOME_GIFT = 'fa-gift';
    const FONTAWESOME_GLASS = 'fa-glass';
    const FONTAWESOME_GLOBE = 'fa-globe';
    const FONTAWESOME_HAND_DOWN = 'fa-hand-down';
    const FONTAWESOME_HAND_LEFT = 'fa-hand-left';
    const FONTAWESOME_HAND_RIGHT = 'fa-hand-right';
    const FONTAWESOME_HAND_UP = 'fa-hand-up';
    const FONTAWESOME_HD_VIDEO = 'fa-hd-video';
    const FONTAWESOME_HDD = 'fa-hdd';
    const FONTAWESOME_HEADER = 'fa-header';
    const FONTAWESOME_HEADPHONES = 'fa-headphones';
    const FONTAWESOME_HEART = 'fa-heart';
    const FONTAWESOME_HEART_EMPTY = 'fa-heart-empty';
    const FONTAWESOME_HOME = 'fa-home';
    const FONTAWESOME_IMPORT = 'fa-import';
    const FONTAWESOME_INBOX = 'fa-inbox';
    const FONTAWESOME_INDENT_LEFT = 'fa-indent-left';
    const FONTAWESOME_INDENT_RIGHT = 'fa-indent-right';
    const FONTAWESOME_INFO_SIGN = 'fa-info-sign';
    const FONTAWESOME_ITALIC = 'fa-italic';
    const FONTAWESOME_LEAF = 'fa-leaf';
    const FONTAWESOME_LINK = 'fa-link';
    const FONTAWESOME_LIST = 'fa-list';
    const FONTAWESOME_LIST_ALT = 'fa-list-alt';
    const FONTAWESOME_LOCK = 'fa-lock';
    const FONTAWESOME_LOG_IN = 'fa-log-in';
    const FONTAWESOME_LOG_OUT = 'fa-log-out';
    const FONTAWESOME_MAGNET = 'fa-magnet';
    const FONTAWESOME_MAP_MARKER = 'fa-map-marker';
    const FONTAWESOME_MINUS = 'fa-minus';
    const FONTAWESOME_MINUS_SIGN = 'fa-minus-sign';
    const FONTAWESOME_MOVE = 'fa-move';
    const FONTAWESOME_MUSIC = 'fa-music';
    const FONTAWESOME_NEW_WINDOW = 'fa-new-window';
    const FONTAWESOME_OFF = 'fa-off';
    const FONTAWESOME_OK = 'fa-ok';
    const FONTAWESOME_OK_CIRCLE = 'fa-ok-circle';
    const FONTAWESOME_OK_SIGN = 'fa-ok-sign';
    const FONTAWESOME_OPEN = 'fa-open';
    const FONTAWESOME_PAPERCLIP = 'fa-paperclip';
    const FONTAWESOME_PAUSE = 'fa-pause';
    const FONTAWESOME_PENCIL = 'fa-pencil';
    const FONTAWESOME_PHONE = 'fa-phone';
    const FONTAWESOME_PHONE_ALT = 'fa-phone-alt';
    const FONTAWESOME_PICTURE = 'fa-picture';
    const FONTAWESOME_PLANE = 'fa-plane';
    const FONTAWESOME_PLAY = 'fa-play';
    const FONTAWESOME_PLAY_CIRCLE = 'fa-play-circle';
    const FONTAWESOME_PLUS = 'fa-plus';
    const FONTAWESOME_PLUS_SIGN = 'fa-plus-sign';
    const FONTAWESOME_PRINT = 'fa-print';
    const FONTAWESOME_PUSHPIN = 'fa-pushpin';
    const FONTAWESOME_QRCODE = 'fa-qrcode';
    const FONTAWESOME_QUESTION_SIGN = 'fa-question-sign';
    const FONTAWESOME_RANDOM = 'fa-random';
    const FONTAWESOME_RECORD = 'fa-record';
    const FONTAWESOME_REFRESH = 'fa-refresh';
    const FONTAWESOME_REGISTRATION_MARK = 'fa-registration-mark';
    const FONTAWESOME_REMOVE = 'fa-remove';
    const FONTAWESOME_REMOVE_CIRCLE = 'fa-remove-circle';
    const FONTAWESOME_REMOVE_SIGN = 'fa-remove-sign';
    const FONTAWESOME_REPEAT = 'fa-repeat';
    const FONTAWESOME_RESIZE_FULL = 'fa-resize-full';
    const FONTAWESOME_RESIZE_HORIZONTAL = 'fa-resize-horizontal';
    const FONTAWESOME_RESIZE_SMALL = 'fa-resize-small';
    const FONTAWESOME_RESIZE_VERTICAL = 'fa-resize-vertical';
    const FONTAWESOME_RETWEET = 'fa-retweet';
    const FONTAWESOME_ROAD = 'fa-road';
    const FONTAWESOME_SAVE = 'fa-save';
    const FONTAWESOME_SAVED = 'fa-saved';
    const FONTAWESOME_SCREENSHOT = 'fa-screenshot';
    const FONTAWESOME_SD_VIDEO = 'fa-sd-video';
    const FONTAWESOME_SEARCH = 'fa-search';
    const FONTAWESOME_SEND = 'fa-send';
    const FONTAWESOME_SHARE = 'fa-share';
    const FONTAWESOME_SHARE_ALT = 'fa-share-alt';
    const FONTAWESOME_SHOPPING_CART = 'fa-shopping-cart';
    const FONTAWESOME_SIGNAL = 'fa-signal';
    const FONTAWESOME_SORT = 'fa-sort';
    const FONTAWESOME_SORT_BY_ALPHABET = 'fa-sort-by-alphabet';
    const FONTAWESOME_SORT_BY_ALPHABET_ALT = 'fa-sort-by-alphabet-alt';
    const FONTAWESOME_SORT_BY_ATTRIBUTES = 'fa-sort-by-attributes';
    const FONTAWESOME_SORT_BY_ATTRIBUTES_ALT = 'fa-sort-by-attributes-alt';
    const FONTAWESOME_SORT_BY_ORDER = 'fa-sort-by-order';
    const FONTAWESOME_SORT_BY_ORDER_ALT = 'fa-sort-by-order-alt';
    const FONTAWESOME_SOUND_5_1 = 'fa-sound-5-1';
    const FONTAWESOME_SOUND_6_1 = 'fa-sound-6-1';
    const FONTAWESOME_SOUND_7_1 = 'fa-sound-7-1';
    const FONTAWESOME_SOUND_DOLBY = 'fa-sound-dolby';
    const FONTAWESOME_SOUND_STEREO = 'fa-sound-stereo';
    const FONTAWESOME_STAR = 'fa-star';
    const FONTAWESOME_STAR_EMPTY = 'fa-star-empty';
    const FONTAWESOME_STATS = 'fa-stats';
    const FONTAWESOME_STEP_BACKWARD = 'fa-step-backward';
    const FONTAWESOME_STEP_FORWARD = 'fa-step-forward';
    const FONTAWESOME_STOP = 'fa-stop';
    const FONTAWESOME_SUBTITLES = 'fa-subtitles';
    const FONTAWESOME_TAG = 'fa-tag';
    const FONTAWESOME_TAGS = 'fa-tags';
    const FONTAWESOME_TASKS = 'fa-tasks';
    const FONTAWESOME_TEXT_HEIGHT = 'fa-text-height';
    const FONTAWESOME_TEXT_WIDTH = 'fa-text-width';
    const FONTAWESOME_TH = 'fa-th';
    const FONTAWESOME_TH_LARGE = 'fa-th-large';
    const FONTAWESOME_TH_LIST = 'fa-th-list';
    const FONTAWESOME_THUMBS_DOWN = 'fa-thumbs-down';
    const FONTAWESOME_THUMBS_UP = 'fa-thumbs-up';
    const FONTAWESOME_TIME = 'fa-time';
    const FONTAWESOME_TINT = 'fa-tint';
    const FONTAWESOME_TOWER = 'fa-tower';
    const FONTAWESOME_TRANSFER = 'fa-transfer';
    const FONTAWESOME_TRASH = 'fa-trash-o';
    const FONTAWESOME_TREE_CONIFER = 'fa-tree-conifer';
    const FONTAWESOME_TREE_DECIDUOUS = 'fa-tree-deciduous';
    const FONTAWESOME_UNCHECKED = 'fa-unchecked';
    const FONTAWESOME_UPLOAD = 'fa-upload';
    const FONTAWESOME_USD = 'fa-usd';
    const FONTAWESOME_USER = 'fa-user';
    const FONTAWESOME_VOLUME_DOWN = 'fa-volume-down';
    const FONTAWESOME_VOLUME_OFF = 'fa-volume-off';
    const FONTAWESOME_VOLUME_UP = 'fa-volume-up';
    const FONTAWESOME_WARNING_SIGN = 'fa-warning-sign';
    const FONTAWESOME_WRENCH = 'fa-wrench';
    const FONTAWESOME_ZOOM_IN = 'fa-zoom-in';
    const FONTAWESOME_ZOOM_OUT = 'fa-zoom-out';
...
//        }
     ...
     */
    public static function glyphicon($icon, $htmlOptions = array(), $tagName = 'span')
    {
        if (is_string($icon)) {
