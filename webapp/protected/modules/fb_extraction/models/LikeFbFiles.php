...
/**
 * This is the model class for table "like_fb_files".
 *
 * The followings are the available columns in table 'like_fb_files':
 * @property string $user_id
 * @property string $ref_entity_id
 */
class LikeFbFiles extends CActiveRecord
{
	/**
	 ...
	 * @return LikeFbFiles the static model class
	 */
