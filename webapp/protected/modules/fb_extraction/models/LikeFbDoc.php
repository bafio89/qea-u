...
/**
 * This is the model class for table "like_fb_doc".
 *
 * The followings are the available columns in table 'like_fb_doc':
 * @property string $user_id
 * @property string $ref_entity_id
 */
class LikeFbDoc extends CActiveRecord
{
	/**
	 ...
	 * @return LikeFbDoc the static model class
	 */
