...
/**
 * This is the model class for table "member_degree_group".
 *
 * The followings are the available columns in table 'member_degree_group':
 * @property string $user_id
 * @property string $user_group_id
 * @property integer $actual_member
 */
class MemberDegreeGroup extends CActiveRecord
{
	/**
	 ...
	 * @return MemberDegreeGroup the static model class
	 */
